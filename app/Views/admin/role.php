    ...
    <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="<?= basename('auth/logout'); ?>" data-toggle="modal" data-target="#logoutModal">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <?= validation_show_error('role') ? '<div class="alert alert-danger" role="alert">' . validation_show_error("role") . '</div>' : '' ?>
